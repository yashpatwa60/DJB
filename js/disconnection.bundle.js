/*! For license information please see disConnection.bundle.js.LICENSE.txt */
!(function () {
  var e = {
      78: function (e, t, n) {
        var i, r, o, a;
        ...
        (a = function (e) {
            ...
            L = {
              ...
              renderDays: function () {
                ...
                for (
                  ...
                  o && (M = A.getTime() < o.getTime()),
                    ...
                    C.push(
                      this.createItem({
                        disabled: M,
                        highlighted: D === m && S === y && A.getDate() === b,
                        muted: !0,
                        picked: D === x && S === w && t === k,
                        text: t,
                        view: "day prev",
                ...
                11 === g ? ((I += 1), (j = 0)) : (j += 1),
                  (e = N(h, g)),
                  (n = 42 - (C.length + e));
                var P = new Date(h, g, e);
                for (
                  a && (O = P.getTime() >= a.getTime()), t = 1;
                  t <= n;
                  t += 1
                ) {
                  var L = new Date(I, j, t),
                    F = I === x && j === w && t === k,
                    $ = !1;
                  a && ($ = L.getTime() > a.getTime()),
                    !$ && c && ($ = !1 === c.call(i, L, "day")),
                    _.push(
                      this.createItem({
                        disabled: $,
                        picked: F,
                        highlighted: I === m && j === y && L.getDate() === b,
                        muted: !0,
                        text: t,
                        view: "day next",
                      })
                ...
                var q = [];
                for (t = 1; t <= e; t += 1) {
                  var H = new Date(h, g, t),
                    B = !1;
                  o && (B = H.getTime() < o.getTime()),
                    !B && a && (B = H.getTime() > a.getTime()),
                    !B && c && (B = !1 === c.call(i, H, "day"));
                  var R = h === x && g === w && t === k,
                    W = R ? "day picked" : "day";
                  q.push(
                    this.createItem({
                      disabled: B,
                      picked: R,
                      highlighted: h === m && g === y && H.getDate() === b,
                      text: t,
                      view: B ? "day disabled" : W,
                    })
                  );
                }
                this.$monthPrev.toggleClass(u, T),
                  ...
                  this.$days.html(C.join("") + q.join("") + _.join(""));
              },
            },
            F = "".concat(s, "-top-left"),
            $ = "".concat(s, "-top-right"),
                    ...
                    value: function () {
                      if (!this.inline) {
                        ...
                        w(p) && (p = 10),
                          ...
                          i.removeClass(B).addClass(h).css({ top: f, left: d });
                      }
                    },
                  },
                  {
          ...
          if ((e.extend && e.extend(R.prototype, L, P, O), e.fn)) {
      ...
      755: function (e, t) {
        ...
        !(function (t, n) {
          ...
          var T = (function (e) {
            ...
            try {
              j.apply((M = O.call(w.childNodes)), w.childNodes),
            ...
            function se(e, t, i, r) {
              ...
              if (!r && (f(t), (t = t || p), g)) {
                ...
                if (
                  ...
                  if (((m = e), (y = t), 1 === w && (U.test(e) || V.test(e)))) {
                    for (
            ...
            function Ce(e, t, n, i, r, o) {
              return (
                ...
                ue(function (o, a, s, l) {
                  ...
                  } else (m = ke(m === a ? m.splice(h, m.length) : m)), r ? r(null, a, m, l) : j.apply(a, m);
                })
              );
            }
            function De(e) {
              ...
              function (e, t) {
                D.fn[e] = function (n, i) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      (L[e] || D.uniqueSort(r), P.test(e) && r.reverse()),
                    this.pushStack(r)
                  );
                };
              }
                  ...
                  r = {
                    ...
                    then: function (e, n, r) {
                      ...
                      return D.Deferred(function (i) {
                        t[0][3].add(a(0, i, m(r) ? r : q, i.notifyWith)),
                          t[1][3].add(a(0, i, m(e) ? e : q)),
            ...
            return (
              (n =
                void 0 !== e.getElementsByTagName
                  ...
                  : []),
              void 0 === t || (t && M(e, t)) ? D.merge([e], n) : n
            );
          }
          function we(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                  ...
                  if (
                    ...
                    a &&
                      ...
                      ((d.teardown && !1 !== d.teardown.call(e, h, v.handle)) ||
                        D.removeEvent(e, p, v.handle),
                      delete l[p]);
                  } else for (p in l) D.event.remove(e, p + t[u], n, i, !0);
          ...
          function $e(e, t, n, i) {
            ...
            if (
              g ||
              (f > 1 && "string" == typeof h && !v.checkClone && _e.test(h))
            )
            ...
            if (
              ...
              if (s)
                for (
                  c = a[a.length - 1].ownerDocument, D.map(a, Pe), d = 0;
                  d < s;
                  d++
                )
                  (u = a[d]),
          ...
          D.extend({
            ...
            (D.cssHooks.marginLeft = Ue(v.reliableMarginLeft, function (e, t) {
              if (t)
                return (
              ...
              function (e, t, n) {
                ...
                t))
                  if (((r = t[i]), at.test(r))) {
                    ...
                    p[i] = (v && v[i]) || D.style(e, i);
                  }
                if ((l = !D.isEmptyObject(t)) || !D.isEmptyObject(p))
                  for (i in (d &&
                    1 === e.nodeType &&
                  ...
                  return void 0 === e.getAttribute
                    ...
                    : ((1 === o && D.isXMLDoc(e)) ||
                        (r =
                          ...
                          (D.expr.match.bool.test(t) ? pt : void 0)),
                      void 0 !== n
                        ? null === n
            ...
            D.extend({
              ...
              ajax: function (e, t) {
                ...
                if (
                  ...
                  if (
                    ((C.readyState = 1), c && g.trigger("ajaxSend", [C, p]), u)
                  )
                    return C;
                  p.async &&
                    p.timeout > 0 &&
          ...
          D.ajaxSetup({
            ...
            D.each(["top", "left"], function (e, t) {
              D.cssHooks[t] = Ue(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Ve(e, t)), He.test(n) ? D(e).position()[t] + "px" : n
                  );
              });
            }),
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      (function (e) {
        ...
        n(615);
      var p = "https://djb.gov.in/DJBRMSApp/rest/Services/",
        h = "9DIc4QllN1uEzjaS3LitMeAoo5cbeJ7FSHfG4AfHUwk=",
        g = {
      ...
      var v,
        m = JSON.parse(localStorage.getItem("loginUser")),
        y = localStorage.getItem("loginUserName");
      null == m
        ? (t()("#vfsFlag").append(
            '<option value="SELF" selected="selected">SELF</option>'
          ),
          t()("#vfsID").val("SELF"))
        : "VFS" == y.slice(0, 3).toUpperCase()
        ? (t()("#vfsFlag").append(
        ...
        t()("#validateKNO").css("display", "block"),
        t()(".checkValidKnoIcon").css({ display: "block", color: "gray" }),
        t()("#viewDisconnPage").css("display", "none"),
        t()("#typeOfDisDiv").css("display", "none"),
        t()("#KNO").keypress(function (e) {
          return c(e);
        }),
        t()("#disConnKNOValidate").on("click", function () {
          t()('input[name="ApplyFor"]:checked').prop("checked", !1),
            t()('input[name="Type"]:checked').prop("checked", !1);
          var e = t()("#KNO").val();
          if ("" == e)
            return (
              f("Alert", "Please fill valid KNO."),
              t()("#mutationModelBtn").trigger("click"),
              !1
            );
          d(p + "Disconnection/DisconOnload/" + e, "", g, function (e) {
            "Success" == e.message && 200 == e.statusCode
              ? (t().each(e.proofOfIdentityList, function (e, n) {
                ...
                (v = e.userVO.consumerBean),
                t()("#PhnNum").val(v.LandLine),
                t()("#EmailId").val(v.Emailid),
                t()("#MobNum").val(v.Phone),
                t()("#Kno").val(v.kNO),
                t()("#PremiseID").val(v.premiseID),
                t()("#PersonId").val(v.personID),
                b(),
                "INVALID" == v.kNO
                  ? (t()(".checkValidKnoIcon").css({
                    ...
                    f("Alert", "Invalid KNO !"),
                    t()("#mutationModelBtn").trigger("click"))
                  : (t()("#viewDisconnPage").css("display", "block"),
                    t()(".checkValidKnoIcon").css({
                      display: "block",
                      color: "green",
                    })))
        ...
        t()("#ApplyForDisc").on("click", function () {
          t()("#typeOfDisDiv").css("display", "block");
        });
      var b = function () {
          t()("#viewDisconnData input").prop("disabled", !0),
            t()("#viewDisconnData textarea").prop("disabled", !0),
            t()("#viewDisconnData select").prop("disabled", !0);
        },
        x = function () {
          t()("#viewDisconnData input").prop("disabled", !1),
            t()("#viewDisconnData textarea").prop("disabled", !1),
            t()("#viewDisconnData select").prop("disabled", !1);
        };
      t()("#ApplyForReopen").on("click", function () {
        t()("#typeOfDisDiv").css("display", "none"), w();
      }),
        t()("#Type").on("click", function () {
          w();
        }),
        t()("#Type1").on("click", function () {
          w();
        }),
        t()("#EmailId").on("blur", function () {
          var e = t()("#EmailId").val();
          return (
            !!/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(
              String(e).toLowerCase()
            ) ||
            (f("Alert", "Not a valid Email Address."),
            t()("#mutationModelBtn").trigger("click"),
            !1)
          );
        }),
        t()("#MobNum").prop("maxlength", "10"),
        t()("#MobNum").keypress(function (e) {
          return c(e);
        });
      var w = function () {
          var e = t()('input[name="ApplyFor"]:checked').val();
          t()("#ServiceAggType").val(v.serviceAgreementType);
          var n = t()("#ServiceAggType").val();
          console.log("varServiceAggType:::" + n),
            ("CM_REOPEN" != e || (null != n && "" != n && "SASEWER" != n)) &&
            ("CM_DISCON" != e ||
              ("SAWATR" != n && "SAWATSEW" != n && "UNMTRD" != n)) &&
            ("CM_MTEST" != e || ("SAWATR" != n && "SAWATSEW" != n))
              ? (b(),
                f("Alert", "Cannot Proceed! Service Agreement Type Not Valid!"),
                t()("#mutationModelBtn").trigger("click"))
              : k();
        },
        k = function () {
          var e = t()("#Kno").val(),
            n = t()("#PremiseID").val(),
            i = t()('input[name="ApplyFor"]:checked').val();
          return null == e || "" == e
            ? (b(),
              f("Alert", "Cannot Proceed! Your KNO doesnot exist!"),
              t()("#mutationModelBtn").trigger("click"),
              !1)
            : null == n || ("" == n && "CM_REOPEN" != i)
            ? (b(),
              f("Alert", "Cannot Proceed! Your Premise ID doesnot exist!"),
              t()("#mutationModelBtn").trigger("click"),
              !1)
            : void C();
        },
        C = function () {
          var e = t()('input[name="ApplyFor"]:checked').val(),
            n = t()("#Kno").val(),
            i = t()("#PremiseID").val();
          t()("#ServiceAggType").val(),
            d(
              p + "Disconnection/ValidateAccess/" + n + "/" + e,
              "",
              g,
              function (e) {
                if ("Success" == e.message && 200 == e.statusCode) {
                  var n = e.validateFlag,
                    r = e.apply;
                  "CM_REOPEN" == r
                    ? t()("#PremiseID").val(e.premiseID)
                    : t()("#PremiseID").val(),
                    console.log("varPremID::::" + i),
                    "N" == n
                      ? (b(),
                        f(
                          "Alert",
                          "Cannot Proceed! Already a case of this type is open under your name!"
                        ),
                        t()("#mutationModelBtn").trigger("click"))
                      : "M" == n && "CM_REOPEN" != r
                      ? (b(),
                        f(
                          "Alert",
                          "Cannot Proceed! Valid SA doesnot exist under your name!"
                        ),
                        t()("#mutationModelBtn").trigger("click"))
                      : "P" == n
                      ? (b(),
                        f(
                          "Alert",
                          "Cannot Proceed! Consumer is not eligible for reopening!"
                        ),
                        t()("#mutationModelBtn").trigger("click"))
                      : "O" == n
                      ? (b(),
                        f(
                          "Alert",
                          "Cannot Proceed! A Meter Testing Case exist under your name in last 6 months!"
                        ),
                        t()("#mutationModelBtn").trigger("click"))
                      : "Error" == n
                      ? (f("Alert", n + " Something Went Worng"),
                        t()("#mutationModelBtn").trigger("click"))
                      : "Y" == n
                      ? x()
                      : "CM_REOPEN" == r || "" == i
                      ? (f(
                          "Alert",
                          "Cannot Proceed! Permise Id not valid for reopening!"
                        ),
                        t()("#mutationModelBtn").trigger("click"))
                      : ("CM_REOPEN" != r && "" == i) ||
                        (t()("#PremiseID").val(e.premiseID), x());
                } else
                  f("Alert", e.message),
                    t()("#mutationModelBtn").trigger("click");
              }
      ...
      var D = function () {
        var e = t()('input[name="ContactType"]:checked').val(),
          n = t()('input[name="ApplyFor"]:checked').val(),
          i = t()('input[name="Type"]:checked').val(),
          r = t()("#Comments").val(),
          o = t()("#PhnNum").val(),
          a = t()("#MobNum").val(),
          s = t()("#EmailId").val(),
          l = t()("#ProofIdentityCombo").val(),
          u = t()("#DocNo").val(),
          c = t()("#Document_proofIdentity").val(),
          d = t()("#Document_proofLastBill").val(),
          p = t()("#ownershipDoc").val(),
          h = t()("#profilePic").val(),
          g = t()("#signature").val(),
          v = t()("#PersonId").val(),
          m = t()("#PremiseID").val();
        return null == v || "" == v
          ? (f("Alert", "Person ID does not exist"),
            t()("#mutationModelBtn").trigger("click"),
            !1)
          : null == m || ("" == m && "CM_REOPEN" != n)
          ? (f("Alert", "Premise ID does not exist"),
            t()("#mutationModelBtn").trigger("click"),
            !1)
          : null == n || "" == n
          ? (f("Alert", "Please Select Application For"),
            t()("#mutationModelBtn").trigger("click"),
            !1)
          : "CM_DISCON" != n || (null != i && "" != i)
          ? null == r || "" == r
            ? (f("Alert", "Please Enter Proper Comments"),
              t()("#mutationModelBtn").trigger("click"),
              !1)
            : "PH" != e || (null != a && "" != a)
            ? "PH" == e && 10 != a.length
              ? (f("Alert", "Please Enter 10 digit Mobile Number"),
                t()("#mutationModelBtn").trigger("click"),
                !1)
              : null == l || "" == l
              ? (f("Alert", "Please Select Proof of Identity"),
                t()("#mutationModelBtn").trigger("click"),
                !1)
              : null == u || "" == u
              ? (f("Alert", "Please Enter Identity Document Number"),
                t()("#mutationModelBtn").trigger("click"),
                !1)
              : null == c || "" == c
              ? (f("Alert", "Please Upload Document for Proof of Identity"),
                t()("#mutationModelBtn").trigger("click"),
                !1)
              : null == d || "" == d
              ? (f("Alert", "Please Upload Document for Proof of Last Bill"),
                t()("#mutationModelBtn").trigger("click"),
                !1)
              : "EM" != e || (null != s && "" != s)
              ? "LAND" != e || (null != o && "" != o)
                ? null == h || "" == h
                  ? (f("Alert", "Please Upload Document for Profile Photo"),
                    t()("#mutationModelBtn").trigger("click"),
                    !1)
                  : null == g || "" == g
                  ? (f("Alert", "Please Upload Document for Signature"),
                    t()("#mutationModelBtn").trigger("click"),
                    !1)
                  : null == p || "" == p
                  ? (f("Alert", "Please Upload Document of Ownership"),
                    t()("#mutationModelBtn").trigger("click"),
                    !1)
                  : (t()("#Comments").focus(),
                ...
                : (f(
                    "Alert",
                    "LandLine Number must be provided if Prefered Contact Type is Land Line!"
                  ),
                  t()("#mutationModelBtn").trigger("click"),
                  !1)
              : (f(
                  "Alert",
                  "Email ID must be provided if Prefered Contact Type is Email!"
                ),
                t()("#mutationModelBtn").trigger("click"),
                !1)
            : (f("Alert", "Please Enter Mobile Number"),
              t()("#mutationModelBtn").trigger("click"),
              !1)
          : (f(
              "Alert",
              "Type of Disconnection must be selected for Disconnection!"
            ),
            t()("#mutationModelBtn").trigger("click"),
            !1);
      };
      t()("#applyNewConnection").on("click", function (e) {
        (e.preventDefault(), D()) &&
              ...
              $.ajax(
                (u(
                  (o = {
                    ...
                    url: "https://djb.gov.in/DJBRMSApp/rest/Services/Disconnection/ApplyForDiscon",
                    data: n,
                    cache: !1,
                    contentType: !1,
                    processData: !1,
          ...
          })(0, new FormData(t()("#disConnectionForm")[0]));
      });
    })();
})();
